...
//--------------------------------------	
	...
	{	
		//--------------------------------------		
		$sql =" insert into qa_info values(";
		$sql.=" $qa_no,";
		$sql.=" '$type',";
		$sql.=" '$question',";
		$sql.=" '$answer',";
		...
		if ($result)
		{
			$msg="<font color='blue'>"."新增Q&A-OK"."</font>";			
		}
		else
		{		
			$msg="<font color='red'>"."新增Q&A-ERROR"."</font>";			
		}		
	}
	else
	{
		$msg="<font color='red'>"."此Q&A已重複-ERROR"."</font>";
	}								
//--------------------------------------
//disconnect database
//--------------------------------------	
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">Q&A管理-新增Q&A</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
