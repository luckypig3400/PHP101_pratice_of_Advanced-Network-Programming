...
{
	if (document.AP_CT.f211.checked==false && document.AP_CT.f212.checked==false && document.AP_CT.f213.checked==false && document.AP_CT.f214.checked==false && document.AP_CT.f215.checked==false && document.AP_CT.f216.checked==false && document.AP_CT.f217.checked==false && (document.AP_CT.f218C.checked==false||document.AP_CT.f218.value==""))
	{
	...
	{
		document.AP_CT.action="qa_school_22.php";
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    ...
					    <tr>
			                      <td class="tdHeads" width="150" rowspan="8">答案：</td>
			                      <td class="tdHeads2"><input type="checkbox" name="f211" value="Y">道路太寬</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f212" value="Y">交通號誌的紅燈讓人等太久</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f213" value="Y">交通號誌的綠燈太短，讓人沒有足夠時間穿越馬路</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f214" value="Y">需要行人穿越道(斑馬線)或設置交通號誌</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f215" value="Y">停放路邊的車輛阻擋交通視線</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f216" value="Y">路樹或障礙物阻擋交通視線</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f217" value="Y">無障礙坡道需要改善或維修</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f218C" value="Y">其他<input type="input" name="f218" size="30" class="inputs" maxlength="100"></td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
