...
//--------------------------------------	
	...
	$f116=(isset ($_POST['f116'])) ? $_POST['f116'] : "";
	$f117=(isset ($_POST['f117'])) ? $_POST['f117'] : "";
	$f117C=(isset ($_POST['f117C'])) ? $_POST['f117C'] : "";
//--------------------------------------
...
{
	if (document.AP_CT.f12[0].checked==true||document.AP_CT.f12[1].checked==true||document.AP_CT.f12[2].checked==true||document.AP_CT.f12[3].checked==true||document.AP_CT.f12[4].checked==true||document.AP_CT.f12[5].checked==true)
	{
		document.AP_CT.action="qa_school_20.php";
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    <tr height="60">
			                      ...
			                      <td class="tdHeads2">
			                      <!-- 問卷題目 s-->
			                      <font color="#CC6600"><B>針對路線適合度，您的綜合評分?</B></font>
			                      <!-- 問卷題目 s-->
			                      </td>
			                    </tr>
			                    <!-- 問卷答案 s-->
					    ...
					    <tr>
			                      ...
			                      <td class="tdHeads2"><input type="radio" name="f12" value="1">非常有問題</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f12" value="2">有許多問題</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f12" value="3">有些問題</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f12" value="4">良好</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f12" value="5">非常好</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f12" value="6">極佳</td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
