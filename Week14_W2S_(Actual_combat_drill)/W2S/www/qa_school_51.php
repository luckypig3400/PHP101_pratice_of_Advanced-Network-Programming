...
{
	if (document.AP_CT.f511.checked==false && document.AP_CT.f512.checked==false && document.AP_CT.f513.checked==false && document.AP_CT.f514.checked==false && document.AP_CT.f515.checked==false && document.AP_CT.f516.checked==false && (document.AP_CT.f517C.checked==false||document.AP_CT.f517.value==""))
	{
	...
	{
		document.AP_CT.action="qa_school_52.php";
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    ...
					    <tr>
			                      ...
			                      <td class="tdHeads2"><input type="checkbox" name="f511" value="Y">缺乏綠地、花或樹木</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f512" value="Y">有可怕的狗</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f513" value="Y">有危險份子(不良份子)</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f514" value="Y">光線不足</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f515" value="Y">髒亂，有垃圾和廢棄物</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f516" value="Y">車輛造成的空氣污染</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f517C" value="Y">其他<input type="input" name="f517" size="30" class="inputs" maxlength="100"></td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
