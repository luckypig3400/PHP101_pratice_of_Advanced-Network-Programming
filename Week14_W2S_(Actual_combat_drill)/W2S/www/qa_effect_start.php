...
<form name="AP_CT" action="qa_effect_10.php" method="post">
<!-- header start -->
                              ...
                              <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                                <tr>
                                  <td valign="top" align="center">
                                          <BR>
					  <!--學童走路上下學影響因素 start-->				  
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="10">                                              
					    <tr height="60">
			                      <td class="tdHeads" width="50"><img src="images/_point01.gif" width="25" height="13" align="absmiddle"></td>
			                      <td class="tdHeads2">
			                      <!-- 說明項目 s-->
			                      各位家長：您好！<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;為瞭解您對孩子「走路上下學」所知覺到助力與阻力的情形，特別邀請您填寫本份問卷！<br><br>
			                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本問卷共分為二大部分，第一部份為家長基本資料，第二部份為學童走路上下學之相關影響因素（助力與阻力），請依序做答。您的填答對我們非常重要，將作為教育部規劃走路上學計畫的參考，您的意見我們會予以保密，請安心填寫。謝謝您協助！<br><br><br>
			                      <div align="right">教育部97年度走路上學推動計畫小組  敬上</div>
			                      <!-- 說明項目 s-->
			                      </td>
			                    </tr>
			                  </table>
			                  ...
			                  <table width="550" border="0" cellspacing="0" cellpadding="0" class="font-12" >
			                    ...
			                    <tr> 
			                      <td align="center">
			                      	<input class="btns" type="submit" value="開始填答">			                        
			                      </td>
			                    </tr>                                                                                             
			                  </table> 
			                  <!--學童走路上下學影響因素 end-->
