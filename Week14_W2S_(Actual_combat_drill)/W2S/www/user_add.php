...
//--------------------------------------	
  ...
  // https://www.php.net/manual/en/function.password-hash.php
	...
	{	
		...
		if ($result)
		{
			$msg="<font color='blue'>"."新增使用者帳號-OK"."</font>";			
		}
		else
		{		
			$msg="<font color='red'>"."新增使用者帳號-ERROR"."</font>";			
		}		
	}
	else
	{
		$msg="<font color='red'>"."此使用者帳號已重複-ERROR"."</font>";
	}								
//--------------------------------------
//disconnect database
//--------------------------------------	
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">帳號管理-新增使用者帳號</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
