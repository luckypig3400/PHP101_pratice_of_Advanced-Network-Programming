...
//--------------------------------------	
	...
	{	
		...
		if ($enable=="F")
		{
			...
			if ($result)
			{
				$msg="<font color='blue'>"."刪除使用者帳號-OK"."</font>";			
			}
			else
			{		
				$msg="<font color='red'>"."刪除使用者帳號-ERROR"."</font>";			
			}				
		}
		else
		{
			...
			if ($result)
			{
				$msg="<font color='blue'>"."維護使用者帳號-OK"."</font>";			
			}
			else
			{		
				$msg="<font color='red'>"."維護使用者帳號-ERROR"."</font>";			
			}	
		}
		//--------------------------------------
	}
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">帳號管理-維護使用者帳號</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
