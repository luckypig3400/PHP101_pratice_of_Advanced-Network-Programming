...
{
	if (document.AP_CT.f311.checked==false && document.AP_CT.f312.checked==false && document.AP_CT.f313.checked==false && document.AP_CT.f314.checked==false && document.AP_CT.f315.checked==false && document.AP_CT.f316.checked==false && (document.AP_CT.f317C.checked==false||document.AP_CT.f317.value==""))
	{
	...
	{
		document.AP_CT.action="qa_school_32.php";
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    ...
					    <tr>
			                      ...
			                      <td class="tdHeads2"><input type="checkbox" name="f311" value="Y">汽車起步或倒車時，未注意行人</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f312" value="Y">經過行人穿越道(斑馬線)時，未禮讓行人</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f313" value="Y">轉彎時，未禮讓行人</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f314" value="Y">車庫出口未減速慢行</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f315" value="Y">車速太快</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f316" value="Y">紅燈亮前加速穿越或闖紅燈</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="checkbox" name="f317C" value="Y">其他<input type="input" name="f317" size="30" class="inputs" maxlength="100"></td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
