...
{
	if (document.AP_CT.f42[0].checked==true||document.AP_CT.f42[1].checked==true||document.AP_CT.f42[2].checked==true||document.AP_CT.f42[3].checked==true||document.AP_CT.f42[4].checked==true||document.AP_CT.f42[5].checked==true)
	{
		document.AP_CT.action="qa_school_50.php";
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    <tr height="60">
			                      ...
			                      <td class="tdHeads2">
			                      <!-- 問卷題目 s-->
			                      <font color="#CC6600"><B>針對學生交通安全行為，您的綜合評分?</B></font>
			                      <!-- 問卷題目 s-->
			                      </td>
			                    </tr>
			                    <!-- 問卷答案 s-->
					    ...
					    <tr>
			                      ...
			                      <td class="tdHeads2"><input type="radio" name="f42" value="1">非常有問題</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f42" value="2">有許多問題</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f42" value="3">有些問題</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f42" value="4">良好</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f42" value="5">非常好</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f42" value="6">極佳</td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
