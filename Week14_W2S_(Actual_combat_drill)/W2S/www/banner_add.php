...
//--------------------------------------	
	...
	//--------------------------------------
	//--------------------------------------
	$sql =" insert into banner_info values(";
	$sql.=" $banner_no,";
	$sql.=" '$title',";
	$sql.=" '$pic_no',";
	$sql.=" '$pic_url',";
	...
	if ($result)
	{
		$msg="<font color='blue'>"."新增廣告-OK"."</font>";			
	}
	else
	{		
		$msg="<font color='red'>"."新增廣告-ERROR"."</font>";
	}		
//--------------------------------------
//disconnect database
//--------------------------------------	
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">廣告管理-新增廣告內容</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
