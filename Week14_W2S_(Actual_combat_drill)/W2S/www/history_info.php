...
<!--
<form name="AP_CT" action="history_update.php" method="post" onsubmit="return form_action()">
...
<!-- work sheet start-->                      
	<table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
			...
			<input type="button" name="page7" class="btnsPage1" value="評分總表" onclick="chg_page(7)">
	            ...
	            <!-- 訪視資料表 --->
                    ...
                    <tr id="obj7">
                      ...
                      <td class="tdHeads2">
                      <input name="f01" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[8])?"checked":""; ?>>校長
                      <input name="f02" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[9])?"checked":""; ?>>主任
                      <input name="f03" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[10])?"checked":""; ?>>教職員
                      <input name="f04" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[11])?"checked":""; ?>>老師
                      <input name="f05" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[12])?"checked":""; ?>>學生
                      </td>
                    </tr>
                    <tr id="obj8" valign="top">
                      <td class="tdHeads" width="150">訪視要點：</td>
                      <td class="tdHeads2">
                      <textarea name="content" cols="40" rows="8" readonly><?php echo $data_arr[13]?></textarea>
                      </td>
                    </tr>
	            <!-- 檢核表(1) --->
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f111" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[14])?"checked":""; ?> onChange="chk_f11()"> 1.</td><td>召集學校與政府公部門（交通、警察、教育局、工務局、交通大隊及環保局等）及社區代表，召開工作協調諮詢會議，每學期至少1次。</td></tr>
				<tr valign="top"><td nowrap><input name="f112" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[15])?"checked":""; ?> onChange="chk_f11()"> 2.</td><td>由校長、教務或學務主任、體育組長、衛生組長及護士相關人員或其他單位組成走路上學工作團隊。</td></tr>
				<tr valign="top"><td nowrap><input name="f113" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[16])?"checked":""; ?> onChange="chk_f11()"> 3.</td><td>依據地區與周邊環境特色與需求，研擬推動計畫書，訂定具體的工作目標(成效指標)。</td></tr>
				<tr valign="top"><td nowrap><input name="f114" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[17])?"checked":""; ?> onChange="chk_f11()"> 4.</td><td>調查及統計走路上學方式、周邊車流量、與上下學路線的交通事故。</td></tr>
				<tr valign="top"><td nowrap><input name="f115" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[18])?"checked":""; ?> onChange="chk_f11()"> 5.</td><td>多宣導走路上學活動相關訊息，以增加教職員生、家長與社區居民之認同，每學期至少1次。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj10" valign="top">
                      ...
                      <td class="tdHeads2">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f121" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[19])?"checked":""; ?> onChange="chk_f12()"> 1.</td><td>定期舉辦與走路上學相關會議(不包含校內會議)。</td></tr>
				<tr valign="top"><td nowrap><input name="f122" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[20])?"checked":""; ?> onChange="chk_f12()"> 2.</td><td>協同專家學者或相關單位，檢視學童步行路線之周遭環境及交通安全狀況，制定具體的交通規劃方案與改善策略。</td></tr>
				<tr valign="top"><td nowrap><input name="f123" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[21])?"checked":""; ?> onChange="chk_f12()"> 3.</td><td>爭取學校所在地首長(里長或村長)支持，並整合學校相關預算支應或經費挹助。</td></tr>
				<tr valign="top"><td nowrap><input name="f124" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[22])?"checked":""; ?> onChange="chk_f12()"> 4.</td><td>學校選派教職員或導護志工參加義交訓練。</td></tr>
				<tr valign="top"><td nowrap><input name="f125" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[23])?"checked":""; ?> onChange="chk_f12()"> 5.</td><td>定期調查教職員生對與家長對走路上學活動之知識、態度及行為上的改變以評估執行成效。</td></tr>
				<tr valign="top"><td nowrap><input name="f126" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[24])?"checked":""; ?> onChange="chk_f12()"> 6.</td><td>訂定交通導護志工設置要點，定期辦理招募、培訓與獎勵等活動。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj11">
                      <td class="tdHeads" width="150">自訂工作數量：</td>
                      <td class="tdHeads2"><input type="input" name="f13" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[25]?>" onChange="chk_f13(this)"></td>
                    </tr>
                    <tr id="obj12" valign="top">
                      <td class="tdHeads" width="150">自訂工作內容：</td>
                      <td class="tdHeads2">
                      <textarea name="f14" cols="40" rows="8" readonly><?php echo $data_arr[26]?></textarea>
                      </td>
                    </tr>
                    <tr id="obj13">
                      <td class="tdHeads" width="150">分項評分：</td>
                      <td class="tdHeads2"><input type="input" name="f15" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[27]?>" onChange="chk_f15(this)"></td>
                    </tr>
                    <tr id="obj14">
                      <td class="tdHeads" width="150">評比：</td>
                      <td class="tdHeads2">
                	<select name="f16" onChange="chk_f16(this)" disabled>
	            ...
	            <!-- 檢核表(2) --->
                    <tr id="obj15" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f211" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[29])?"checked":""; ?> onChange="chk_f21()"> 1.</td><td>定期檢視學校內外步行或交通管制設施有無缺損或須改進的地方，每學期至少2次。</td></tr>
				<tr valign="top"><td nowrap><input name="f212" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[30])?"checked":""; ?> onChange="chk_f21()"> 2.</td><td>設置交通導護點、以提升學童走路上學之安全。</td></tr>
				<tr valign="top"><td nowrap><input name="f213" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[31])?"checked":""; ?> onChange="chk_f21()"> 3.</td><td>利用環境適合度評估學校週邊環境，每學期至少一次。</td></tr>
				<tr valign="top"><td nowrap><input name="f214" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[32])?"checked":""; ?> onChange="chk_f21()"> 4.</td><td>定期辦理校內推廣活動，以提升校內師生共識與社區意識，每學期至少1次。</td></tr>
				<tr valign="top"><td nowrap><input name="f215" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[33])?"checked":""; ?> onChange="chk_f21()"> 5.</td><td>定期利用校內各種電子資訊網頁或佈告欄宣導走路上學相關訊息。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj16" valign="top">
                      ...
                      <td class="tdHeads2">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f221" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[34])?"checked":""; ?> onChange="chk_f22()"> 1.</td><td>定期辦理導護志工傷害保險及交通安全裝備之汰舊換新。</td></tr>
				<tr valign="top"><td nowrap><input name="f222" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[35])?"checked":""; ?> onChange="chk_f22()"> 2.</td><td>設置時段性通學巷或人車分流路線。</td></tr>
				<tr valign="top"><td nowrap><input name="f223" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[36])?"checked":""; ?> onChange="chk_f22()"> 3.</td><td>提供工作團隊或導護志工辦公室與集會空間。</td></tr>
				<tr valign="top"><td nowrap><input name="f224" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[37])?"checked":""; ?> onChange="chk_f22()"> 4.</td><td>規劃走路上學路隊，促進學童或親子間的交流與互動。</td></tr>
				<tr valign="top"><td nowrap><input name="f225" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[38])?"checked":""; ?> onChange="chk_f22()"> 5.</td><td>建立個人與班級獎勵制度來提高學童走路上學意願。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj17">
                      <td class="tdHeads" width="150">自訂工作數量：</td>
                      <td class="tdHeads2"><input type="input" name="f23" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[39]?>" onChange="chk_f23(this)"></td>
                    </tr>
                    <tr id="obj18" valign="top">
                      <td class="tdHeads" width="150">自訂工作內容：</td>
                      <td class="tdHeads2">
                      <textarea name="f24" cols="40" rows="8" readonly><?php echo $data_arr[40]?></textarea>
                      </td>
                    </tr>
                    <tr id="obj19">
                      <td class="tdHeads" width="150">分項評分：</td>
                      <td class="tdHeads2"><input type="input" name="f25" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[41]?>" onChange="chk_f25(this)"></td>
                    </tr>
                    <tr id="obj20">
                      <td class="tdHeads" width="150">評比：</td>
                      <td class="tdHeads2">
                	<select name="f26" onChange="chk_f26(this)" disabled>
	            ...
	            <!-- 檢核表(3) --->
                    <tr id="obj21" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f311" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[43])?"checked":""; ?> onChange="chk_f31()"> 1.</td><td>工作協調諮詢會議中包含家長代表及社區重要人士。</td></tr>
				<tr valign="top"><td nowrap><input name="f312" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[44])?"checked":""; ?> onChange="chk_f31()"> 2.</td><td>設置導護商店、以提升學童走路上學之安全。</td></tr>
				<tr valign="top"><td nowrap><input name="f313" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[45])?"checked":""; ?> onChange="chk_f31()"> 3.</td><td>建立導護志工及教職員生交通安全事故之標準緊急處理流程。</td></tr>
				<tr valign="top"><td nowrap><input name="f314" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[46])?"checked":""; ?> onChange="chk_f31()"> 4.</td><td>辦理社區推廣與宣導活動，提高社區居民對走路上學的支持與配合。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj22" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f321" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[47])?"checked":""; ?> onChange="chk_f32()"> 1.</td><td>結合家長、社區及政府組織相關團體之人力與經費支援，建立社區資源檔案。</td></tr>
				<tr valign="top"><td nowrap><input name="f322" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[48])?"checked":""; ?> onChange="chk_f32()"> 2.</td><td>學校師生定期支援社區服務，改善社區交通安全環境(如：找出人行道積水、缺損的地方等)，以創造學校-社區雙贏之契機。</td></tr>
				<tr valign="top"><td nowrap><input name="f323" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[49])?"checked":""; ?> onChange="chk_f32()"> 3.</td><td>公告家長與社區居民學童上下學時段之學區路線、導護站位置及交通路線(替代道路)等。</td></tr>
				<tr valign="top"><td nowrap><input name="f324" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[50])?"checked":""; ?> onChange="chk_f32()"> 4.</td><td>定期邀請導護商店參加工作會議，並暸解導護商店配合情形。</td></tr>
				<tr valign="top"><td nowrap><input name="f325" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[51])?"checked":""; ?> onChange="chk_f32()"> 5.</td><td>召開安親班協調說明會，以配合推廣走路上學活動。</td></tr>
				<tr valign="top"><td nowrap><input name="f326" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[52])?"checked":""; ?> onChange="chk_f32()"> 6.</td><td>老師配合教學，帶領小朋友認識導護商店。</td></tr>
				<tr valign="top"><td nowrap><input name="f327" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[53])?"checked":""; ?> onChange="chk_f32()"> 7.</td><td>公開表揚社區中積極參與的人員或團體。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj23">
                      <td class="tdHeads" width="150">自訂工作數量：</td>
                      <td class="tdHeads2"><input type="input" name="f33" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[54]?>" onChange="chk_f33(this)"></td>
                    </tr>
                    <tr id="obj24" valign="top">
                      <td class="tdHeads" width="150">自訂工作內容：</td>
                      <td class="tdHeads2">
                      <textarea name="f34" cols="40" rows="8" readonly><?php echo $data_arr[55]?></textarea>
                      </td>
                    </tr>
                    <tr id="obj25">
                      <td class="tdHeads" width="150">分項評分：</td>
                      <td class="tdHeads2"><input type="input" name="f35" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[56]?>" onChange="chk_f35(this)"></td>
                    </tr>
                    <tr id="obj26">
                      <td class="tdHeads" width="150">評比：</td>
                      <td class="tdHeads2">
                	<select name="f36" onChange="chk_f36(this)" disabled>
	            ...
	            <!-- 檢核表(4) --->
                    <tr id="obj27" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f411" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[58])?"checked":""; ?> onChange="chk_f41()"> 1.</td><td>辦理教職員相關教育訓練，每學年至少1次，並追蹤相關活動執行成效。</td></tr>
				<tr valign="top"><td nowrap><input name="f412" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[59])?"checked":""; ?> onChange="chk_f41()"> 2.</td><td>辦理交通安全領域之宣導或協同教學活動，每學期至少1次。</td></tr>
				<tr valign="top"><td nowrap><input name="f413" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[60])?"checked":""; ?> onChange="chk_f41()"> 3.</td><td>考核學童交通安全教育課程學習成效，並針對學習狀況不佳者進行輔導追蹤。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj28" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f421" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[62])?"checked":""; ?> onChange="chk_f42()"> 1.</td><td>實施走路技巧、自我安全保護或走路上學之身心效益課程融入教學。</td></tr>
				<tr valign="top"><td nowrap><input name="f422" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[63])?"checked":""; ?> onChange="chk_f42()"> 2.</td><td>實施書包減重方案，並定期評估實施成效。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj29">
                      <td class="tdHeads" width="150">自訂工作數量：</td>
                      <td class="tdHeads2"><input type="input" name="f43" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[64]?>" onChange="chk_f43(this)"></td>
                    </tr>
                    <tr id="obj30" valign="top">
                      <td class="tdHeads" width="150">自訂工作內容：</td>
                      <td class="tdHeads2">
                      <textarea name="f44" cols="40" rows="8" readonly><?php echo $data_arr[65]?></textarea>
                      </td>
                    </tr>
                    <tr id="obj31">
                      <td class="tdHeads" width="150">分項評分：</td>
                      <td class="tdHeads2"><input type="input" name="f45" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[66]?>" onChange="chk_f45(this)"></td>
                    </tr>
                    <tr id="obj32">
                      <td class="tdHeads" width="150">評比：</td>
                      <td class="tdHeads2">
                	<select name="f46" onChange="chk_f46(this)" disabled>
	            ...
	            <!-- 檢核表(5) --->
                    <tr id="obj33" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f511" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[68])?"checked":""; ?> onChange="chk_f51()"> 1.</td><td>提供教職員生、家長跟社區居民相關教育宣導資料。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj34" valign="top">
                      ...
                      <td class="tdHeads2" width="400">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr valign="top"><td nowrap><input name="f521" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[69])?"checked":""; ?> onChange="chk_f52()"> 1.</td><td>輔導教師編製走路上學學童手冊與教學輔導手冊。</td></tr>
				<tr valign="top"><td nowrap><input name="f522" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[70])?"checked":""; ?> onChange="chk_f52()"> 2.</td><td>建立社區安全危害熱點(hot spot)資料。</td></tr>
				<tr valign="top"><td nowrap><input name="f523" type="checkbox" value="Y" onClick="return false;" <?php echo ($data_arr[71])?"checked":""; ?> onChange="chk_f52()"> 3.</td><td>編制走路上下學相關教案。</td></tr>
			</table>
                      </td>
                    </tr>
                    <tr id="obj35">
                      <td class="tdHeads" width="150">自訂工作數量：</td>
                      <td class="tdHeads2"><input type="input" name="f53" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[72]?>" onChange="chk_f53(this)"></td>
                    </tr>
                    <tr id="obj36" valign="top">
                      <td class="tdHeads" width="150">自訂工作內容：</td>
                      <td class="tdHeads2">
                      <textarea name="f54" cols="40" rows="8" readonly><?php echo $data_arr[73]?></textarea>
                      </td>
                    </tr>
                    <tr id="obj37">
                      <td class="tdHeads" width="150">分項評分：</td>
                      <td class="tdHeads2"><input type="input" name="f55" class="inputs" size="3" maxlength="5" readonly value="<?php echo $data_arr[74]?>" onChange="chk_f55(this)"></td>
                    </tr>
                    <tr id="obj38">
                      <td class="tdHeads" width="150">評比：</td>
                      <td class="tdHeads2">
                	<select name="f56" onChange="chk_f56(this)" disabled>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="tdHeads2">
				...
				<tr valign="top"><td width="200">分項評分：<span id="span_f55"><?php echo $data_arr[74]?></span></td><td width="200">評比：<span id="span_f56"><?php echo $fx6_group[$data_arr[75]]; ?></span></td></tr>
                    ...
                    <tr id="obj45" valign="top">
                      ...
                      <td class="tdHeads2">
                      <textarea name="f61" cols="40" rows="8" readonly><?php echo $data_arr[76]?></textarea>
                      </td>
                    </tr>
                    <tr>
