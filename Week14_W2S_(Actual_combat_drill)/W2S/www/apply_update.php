...
/*
		if ($enable=="F")
		{
			...
			if ($result)
			{
				$msg="<font color='blue'>"."刪除申請表-OK"."</font>";			
			}
			else
			{		
				$msg="<font color='red'>"."刪除申請表-ERROR"."</font>";			
			}				
		}
		else
		{
*/
			...
			if ($result)
			{
				$msg="<font color='blue'>"."維護申請表-OK"."</font>";			
			}
			else
			{		
				$msg="<font color='red'>"."維護申請表-ERROR"."</font>";			
			}	
//		}
		//--------------------------------------
	}
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">報名學校管理-維護報名學校</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
