...
{
	if (document.AP_CT.f50[0].checked==true)
	{
		document.AP_CT.action="qa_school_52.php";
		document.AP_CT.submit();
	}
	else if (document.AP_CT.f50[1].checked==true)
	{
		document.AP_CT.action="qa_school_51.php";
		document.AP_CT.submit();
	}
	else
	{
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    <tr height="60">
			                      ...
			                      <td class="tdHeads2">
			                      <!-- 問卷題目 s-->
			                      <font color="#CC6600"><B>該路線的環境是否令人感到愉快?</B></font>
			                      <!-- 問卷題目 s-->
			                      </td>
			                    </tr>
			                    <!-- 問卷答案 s-->
					    ...
					    <tr>
			                      ...
			                      <td class="tdHeads2"><input type="radio" name="f50" value="1">是</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f50" value="2">有點不愉快</td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
