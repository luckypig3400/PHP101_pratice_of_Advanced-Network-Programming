...
//--------------------------------------	
	...
	{
		//--------------------------------------	
		$sql =" select a.qa_no,a.question,a.answer";
		$sql.=" from qa_info a";
              ...
              <tr>
                <td>
                  <table width="181" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr> 
                      <td><img src="btn/peo-a01.gif" width="181" height="24"></td>
                    </tr>
                    <tr> 
                      <td><img src="btn/peo-a02.gif" width="181" height="25"></td>
                    </tr>
                    <tr> 
                      <td><img src="btn/peo-a03.gif" width="181" height="24"></td>
                    </tr>
                    <tr> 
                      <td><img src="btn/peo-a04.gif" width="181" height="24"></td>
                    </tr>
                    <tr> 
                      <td><A href="qa1_list.php"><img border="0" src="btn/peo-a05.gif" width="181" height="25"></A></td>
                    </tr>
                    <tr> 
              ...
              <tr> 
                <td> 
                  <table width="596" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr> 
                      <td><b><font color="#CC6600">學生Q&A</font></b></td>
                    </tr>
                    <tr> 
					  ...
					  <table width="570" border="0" cellspacing="0" cellpadding="0" class="font-12" >
			                    ...
			                    <tr> 
			                      <td height="25" align="left">			                       
			                       <font color="#006699"><?php echo $data_arr[1]?></font></td>
			                    </tr>			                    
			                    <!--解決方案-->
			                    <tr> 
			                      <td height="10">&nbsp;</td>
