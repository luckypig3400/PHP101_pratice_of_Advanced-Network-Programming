...
<form name="AP_CT" action="schedule_new.php" method="post">
<!-- header start -->
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">評核行程管理-評核行程列表</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
<!-- List Header S-->
            <table width="670" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                ...
                <input class="btns" type="button" value="新增行程" onClick="form_action()">              
                </td>
              </tr>
              <tr>
		    ...
		    ?>	
		    	<?php 
	                ...
	                ?>
	                      	...
	                      	<td align="left" width="200"><a href="schedule_info.php?schedule_no=<?php echo $data_arr[0]?>"><?php echo $data_arr[2] ?></a></td>
	                      	<td align="center" width="80"><?php echo $data_arr[3] ?></td>
	                      	<td align="left" width="150"><?php echo $data_arr[4] ?></td>
	                      	<td align="left" width="120"><?php echo $data_arr[5] ?></td>	                      		                      		                      	                      		                      		                      		                      	
	                    	</tr>   
		    <?php
		    }
		    ?>	
