...
<form name="AP_CT" enctype="multipart/form-data" action="seed_pic_add.php" method="post" onsubmit="return form_action()" target="pic_top">
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">活動管理-輸入上傳圖片</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
