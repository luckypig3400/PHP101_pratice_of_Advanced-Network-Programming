...
{
	document.AP_CT.action="seed_album_list.php?seed_no=<?php echo $seed_no ?>";
	document.AP_CT.method="GET";
...
<form name="AP_CT" enctype="multipart/form-data" action="seed_album_add.php" method="post" onsubmit="return form_action()" target="pic_top">
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">相簿管理-輸入上傳圖片</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
<!-- work sheet start-->                      
	<table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
		    ...
		    <tr>
                    ...
                    <tr>
                      <td class="tdHeads" width="150"><font color='red'>＊</font>圖片標題：</td>
                      <td class="tdHeads2">
                    ...
                    <tr>
                      <td class="td_title" colspan="2" >
                        <input class="btns" type="submit" value="新增圖片">
                        <input class="btns" type="reset" value="重新輸入">
                        <input class="btns" type="button" value="取消" onClick="form_cancel()">
                      </td>
                    </tr>
                  </table>
                </td>
