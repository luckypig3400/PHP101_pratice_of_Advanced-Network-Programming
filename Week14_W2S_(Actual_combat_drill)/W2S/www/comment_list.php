...
{
	//document.AP_CT.action="comment_list.php";
	document.AP_CT.submit();
}
</script>
<!-----javascript code E----->
<body class="body_main">
<form name="AP_CT" action="comment_list.php" method="post">
<!-- header start -->
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">評核意見管理-評核意見列表</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
...
<!-- List Header S-->
            <table width="650" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
              	<td width="600" align="right"><font color='red'>狀態：</font></td>
		    ...
		    ?>	
		    	<?php
	                ...
	                ?>
	                      	...
	                      	<td align="left" width="200"><a href="comment_info.php?schedule_no=<?php echo $data_arr[0]?>"><?php echo $data_arr[2] ?></a></td>
