...
//processing
//--------------------------------------	
	$sql =" insert into qa_school values(";
	$sql.=" $qa_no,";
	$sql.=" '$join_date',";
	$sql.=" NULL,";
	$sql.=" NULL,";
...
{
	if (document.AP_CT.f10[0].checked==true)
	{
		document.AP_CT.action="qa_school_12.php";
		document.AP_CT.submit();
	}
	else if (document.AP_CT.f10[1].checked==true)
	{
		document.AP_CT.action="qa_school_11.php";
		document.AP_CT.submit();
	}
	else
	{
...
<?php if ($idx==1) { ?>
					  ...
					  <table class="table_in" width="550" border="0" cellspacing="1" cellpadding="3">                                              
					    <tr height="60">
			                      ...
			                      <td class="tdHeads2">
			                      <!-- 問卷題目 s-->
			                      <font color="#CC6600"><B>該路線是否適合走路上下學?</B></font>
			                      <!-- 問卷題目 s-->
			                      </td>
			                    </tr>
			                    <!-- 問卷答案 s-->
					    ...
					    <tr>
			                      <td class="tdHeads" width="150" rowspan="2">答案：</td>
			                      <td class="tdHeads2"><input type="radio" name="f10" value="1">適合</td>
			                    </tr>
					    <tr>
			                      <td class="tdHeads2"><input type="radio" name="f10" value="2">有一點問題</td>
			                    </tr>
			                    <!-- 問卷答案 e-->	                    			                    
			                  </table>  
			                  <!-- 功能鍵-->
