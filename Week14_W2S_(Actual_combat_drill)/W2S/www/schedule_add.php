...
//--------------------------------------	
	...
	//--------------------------------------
	//--------------------------------------
	$sql =" insert into comment_schedule values(";
	$sql.=" $schedule_no,";
	$sql.=" '$issue_date',";
	$sql.=" '$school_no',";
	$sql.=" '$issue_times',";
	...
	if ($result)
	{
		$msg="<font color='blue'>"."新增輔導評核行程-OK"."</font>";			
	}
	else
	{		
		$msg="<font color='red'>"."新增輔導評核行程-ERROR"."</font>";			
	}		
//--------------------------------------
//disconnect database
//--------------------------------------	
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">評核行程管理-新增評核行程</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
