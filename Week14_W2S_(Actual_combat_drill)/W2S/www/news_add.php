...
//--------------------------------------	
	...
	//--------------------------------------
	//--------------------------------------
	$sql =" insert into news_info values(";
	$sql.=" $news_no,";
	$sql.=" '$issue_date',";
	$sql.=" '$type',";
	$sql.=" '$subject',";
	...
	if ($result)
	{
		$msg="<font color='blue'>"."新增最新消息-OK"."</font>";			
	}
	else
	{		
		$msg="<font color='red'>"."新增最新消息-ERROR"."</font>";
	}		
//--------------------------------------
//disconnect database
//--------------------------------------	
              ...
              <tr> 
                <td background="images/block-top01.gif" height="60" valign="top"> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      <td width="7%">&nbsp;</td>
                      <td width="93%"><b><font color="#FFFFFF">消息管理-新增最新消息</font></b></td>
                    </tr>
                  </table>
                </td>
              </tr>
